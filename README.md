...
jobs:
  ...
  pr:
    ...
    steps:
      - uses: danielroe/uppt/pr@3ebfa461eb9c99cddc94ce2009835638a134bd3b # v0.6.2
        with:
  ...
  release:
    ...
    steps:
      - uses: danielroe/uppt/release@3ebfa461eb9c99cddc94ce2009835638a134bd3b # v0.6.2
        with:
          token: ${{ secrets.GITHUB_TOKEN }}
  ...
  pack:
    ...
    steps:
      - id: pack
        uses: danielroe/uppt/pack@3ebfa461eb9c99cddc94ce2009835638a134bd3b # v0.6.2
  ...
  publish:
    ...
    steps:
      - uses: danielroe/uppt/publish@3ebfa461eb9c99cddc94ce2009835638a134bd3b # v0.6.2
        with:
